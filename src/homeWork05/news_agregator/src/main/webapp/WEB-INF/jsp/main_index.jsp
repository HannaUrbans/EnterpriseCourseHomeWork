			...
			<div class="buttons_block">
				<form action="Controller" method="Get">
					<button type="submit" name="command"
						value="GO_TO_AUTHENTIFICATION_PAGE">Войти в личный
						кабинет</button>
				</form>

				<form action="Controller" method="Get">
					<button type="submit" name="command"
						value="GO_TO_REGISTRATION_PAGE">Зарегистрироваться</button>
				</form>
			</div>
									...
									<c:when test="${isBreakingNews}">
										<c:if test="${not empty topNews}">
											<div class="image-container news-item">
												<a
													href="Controller?command=GO_TO_NEWS_PAGE&newsId=${topNews.id}">
										...
										<c:forEach var="index" begin="0"
											...
											<c:if test="${regularNewsSize - 1 - index >= 0}">
												<div class="image-container news-item">
													<a
														href="Controller?command=GO_TO_NEWS_PAGE&newsId=${regularNews[regularNewsSize - 1 - index].id}">
														<img
							...
							<div class="news_item">
								<div class="image-container">
									<c:choose>
										<c:when test="${isBreakingNews}">
											<a
												href="Controller?command=GO_TO_NEWS_PAGE&newsId=${breakingNews.id}">
